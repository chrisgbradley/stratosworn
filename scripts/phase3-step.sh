...
powershell -NoProfile -Command "Start-Process -FilePath '$ROOT/telemetry/gradlew.bat' -ArgumentList 'runClientJoin','--console=plain' -WorkingDirectory '$ROOT/telemetry' -WindowStyle Hidden -RedirectStandardOutput \"\$env:TEMP\stratos-client.out\" -RedirectStandardError \"\$env:TEMP\stratos-client.err\""
